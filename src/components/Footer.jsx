    ...
    <div className="mt-40 flex flex-col gap-5 px-8">
      <div className="flex justify-between items-start flex-col md:flex-row gap-7">
        ...
        <ul className="flex flex-col items-start justify-start gap-3">
          ...
          <li className="footerLi">About Bizionic</li>
        ...
        <ul className="flex flex-col items-start justify-start  gap-3">
          ...
          <li className="footerLi">Bizionic for Android</li>
          <li className="footerLi">Bizionic for iOS</li>
      ...
      <div className="border-t-2 border-[#CBD4E6] py-8 flex justify-between items-center">
        ...
        <p className="text-[#7C8DB0] text-sm sm:text-base">&copy; 2025 Bizionic incorporated</p>
      </div>
    </div>
    </>
  )
