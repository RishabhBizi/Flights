...
const PlacesCardV2 = ({ image, title, name, desc }) => {
  return (
    <>
    <div className="w-[410.67px] h-[520px] flex flex-col justify-start gap-2 dealsShadow rounded-b">
       <div className="w-full h-[397px]">
         <img src={image} alt="images" className="w-full h-full object-cover rounded-t h-[95%]"/>
       </div>
       <div className="w-full h-fit-content flex flex-col items-start justify-center gap-1 px-4">
